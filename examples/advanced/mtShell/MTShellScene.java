...
//		logger.setLevel(Level.DEBUG);
	 ...
	 * @param name the name
	 */
	public MTShellScene(final MTApplication mtApplication, String name) {
...
//		list.setPositionGlobal(new Vector3D(app.width/2f - list.getWidthXY(TransformSpace.GLOBAL)/2f, app.height - 20));
		...
		PImage arrow = mtApplication.loadImage( imagesPath +"arrowRight.png");
		...
		previousSceneButton.setPositionGlobal(new Vector3D(previousSceneButton.getWidthXY(TransformSpace.GLOBAL) + 5, mtApplication.height - previousSceneButton.getHeightXY(TransformSpace.GLOBAL) - 5, 0));
